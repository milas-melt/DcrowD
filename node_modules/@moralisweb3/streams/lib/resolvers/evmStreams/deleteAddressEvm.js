...
var apiToResult = function (apiData) {
    ...
    return __assign(__assign({}, data), { address: data.address ? evm_utils_1.EvmAddress.create(data.address) : undefined });
};
exports.deleteAddressEvm = (0, api_utils_1.createEndpointFactory)(function () {
    return (0, api_utils_1.createEndpoint)({
        ...
        resultToJson: function (data) { return (__assign(__assign({}, data), { address: data.address ? data.address.format() : undefined })); },
